...
| `type`            | STRING      | Y        |     |     | `individualDeductible`<br/>`individualCoinsurance`<br/>`individualMaxPay`<br/>`familyDeductible`<br/>`familyCoinsurance`<br/>`familyMaxPay`                                                                                                 | The type of accumulator.                                                                                   |
| `coverageType`    | STRING      | Y        |     |     | `debtProtect`<br/>`dental`<br/>`drug`<br/>`drugSecondary`<br/>`gym`<br/>`healthcareIndemnity`<br/>`life`<br/>`mec`<br/>`medical`<br/>`medicalSecondary`<br/>`noCostRx`<br/>`pet`<br/>`rxCash`<br/>`virtualCare`<br/>`vision`<br/>`wellness` | The type of coverage.                                                                                      |
| `applicability`   | STRING      | N        |     |     | `inNetwork`<br/>`outOfNetwork`<br/>`preferred`<br/>`standard`<br/>`tier1`<br/>`tier2`<br/>`tier3`<br/>`domestic`                                                                                                                            | The network to which the accumulator applies. If no value is supplied, it implies universal applicability. |
